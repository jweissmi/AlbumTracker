...
namespace AlbumTracker.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,AlbumName,ArtistID,GenreID,AlbumImage")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,AlbumName,ArtistID,GenreID,AlbumImage")] Album album)
        {
            if (ModelState.IsValid)
            {
